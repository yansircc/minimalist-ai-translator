	...
	const getErrorInfo = () => {
		if (error.message.includes("timeout")) {
			return {
				...
				message:
					"The translation took too long. Please try again with a shorter text.",
				icon: "⏱️",
			};
		}
	...
	return (
		<div className="flex h-full w-full items-center justify-center p-8">
			<div className="max-w-md text-center">
				...
				<h3 className="mb-2 font-semibold text-xl text-zinc-900 dark:text-zinc-100">
					{title}
				</h3>
				...
				{errorCount > 2 && (
					<p className="mb-4 text-xs text-zinc-500 dark:text-zinc-500">
						This error has occurred {errorCount} times. Consider trying a
						different model.
					</p>
				)}
